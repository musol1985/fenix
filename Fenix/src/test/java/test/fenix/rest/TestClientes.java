...
public class TestClientes {
	...
	public void nuevo() throws Exception {
		Cliente c3=new Cliente();c3.setId(null);c3.setNombre("juan2");c3.setApellido1("Martinc3");c3.setApellido2("Lopez");c3.setCentro(centro);c3.setCorreo("juan@gmail.com");c3.setDni("123");c3.setTelefono(6123);
	...
	public void getAll() throws Exception {
		...
		Cliente c1=new Cliente();c1.setNombre("juan");c1.setApellido1("Martinc1");c1.setApellido2("Lopez");c1.setCentro(centro);c1.setCorreo("juan@gmail.com");c1.setDni("123");c1.setTelefono(6123);
		clientes.getDAO().save(c1);
		Cliente c2=new Cliente();c2.setId(null);c2.setNombre("jua2");c2.setApellido1("Martinc2");c2.setApellido2("Lopez");c2.setCentro(centro);c2.setCorreo("juan@gmail.com");c2.setDni("134");c2.setTelefono(6123);
		...
		Cliente c4=new Cliente();c4.setId(null);c4.setNombre("juan2");c4.setApellido1("Martinc4");c4.setApellido2("Lopez");c4.setCentro(cen);c4.setCorreo("juan@gmail.com");c4.setDni("123");c4.setTelefono(6123);
